...
#ifndef OPENVDB_TOOLS_LEVELSETWEDGE_HAS_BEEN_INCLUDED
#define OPENVDB_TOOLS_LEVELSETWEDGE_HAS_BEEN_INCLUDED
...
namespace openvdb {
	...
	namespace OPENVDB_VERSION_NAME {
		namespace tools {
			...
			{
				return createLevelSetWedge<GridType, util::NullInterrupter>(radius, start, end, voxelSize, halfWidth);
			}
			...
			public:
				...
				LevelSetWedge(const Vec3T &p1, const Vec3T &p2, const Vec3T &p3, float thickness, InterruptT* interrupt = NULL)
